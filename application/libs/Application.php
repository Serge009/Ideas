...
class Application {
    ...
    public function __construct()
    {
        ...
        echo class_exists('Main\\Controller\\' . $this->url_controller, false) . 'Main\\Controller\\' . $this->url_controller;
        if (class_exists($this->url_controller, false)) {
            ...
            if (method_exists($this->url_controller, $this->url_action)) {
                ...
                if (isset($this->url_parameter_3)) {
                    ...
                    // if no parameters given, just call the method without parameters, like $this->login->method();
